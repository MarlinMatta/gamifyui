package edu.uapa.ui.gamify.utils.captions;
...
public class Captions {
    ...
    public static final String STUDENT_ITEM = "Estudiante";
    ...
    public static final String TEST_ITEM = "Exámen";
    ...
    public static final String GRID_COLUMN_ACTION = "Acción";
    ...
    public static final String GRID_COLUMN_DESCRIPTION = "Descripcción";
    public static final String GRID_COLUMN_DISTRICT = "Districto";
    public static final String GRID_COLUMN_ADDRESS = "Dirección";
    ...
    public static final String CONFIGURATION = "Configuracción";
