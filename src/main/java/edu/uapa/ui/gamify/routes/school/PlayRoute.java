...
@Route(value = AllRoutes.PLAY_ROUTE, layout = MainAppLayout.class)
public class PlayRoute extends PageView {
    ...
    private Component header() {
        ...
        layout.setWidthFull();
        Span h2 = new Span();
        h2.getElement().setProperty("innerHTML", "<String><u>" + Captions.TEST + "</u></strong>");
